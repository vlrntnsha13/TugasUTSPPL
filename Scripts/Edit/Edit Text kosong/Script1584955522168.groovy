...
WebUI.setText(findTestObject('Page_CodeIgniter Tutorial/input_Title_title'), 'Berita 2- Edit')

WebUI.setText(findTestObject('Object Repository/Page_CodeIgniter Tutorial/textarea_coba'), '')
